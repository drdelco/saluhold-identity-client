 ...
 */
export function comoSexoIdentity(valor) {
    return valor === 'H' || valor === 'M' || valor === 'O' ? valor : undefined;
}
export function esHombre(valor) {
    return valor === 'H' || valor === 'Hombre';
}
export function esMujer(valor) {
 ...
 */
export function sexoDesdeExterno(literal) {
    if (!literal)
        return undefined;
