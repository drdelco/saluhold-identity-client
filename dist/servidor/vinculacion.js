...
export function acunarNumeroHistoria(prefijo = 'ID') {
...
export async function clinicasDelGrupo(db, clinicaId, coleccionTenants = 'tenants') {
    try {
 ...
 */
export async function vincularPacienteEnIdentity(db, arrayUnion, pacienteId, clinicaId, opciones = {}) {
