 ...
 * sitio.
 */
export function aplicarBorrador(actual, borrador) {
...
export function useScanIdDocument() {
     ...
     */
    const leer = useCallback(async (ficheros) => {
        if (!ficheros.length)
            return null;
     ...
     */
    const procesarLectura = useCallback(async (lectura) => {
        cancelado.current = false;
        setEscaneando(true);
        setError(null);
        try {
    ...
    const escanear = useCallback(async (ficheros) => {
...
//# sourceMappingURL=useScanIdDocument.js.map