...
import { pide, avisoIdiomaNacionalidad, } from './altaPaciente';
import { textosUI, interpolar } from './textos';
export default function CamposAltaPaciente({ perfil, valores, onChange, provisional = false, disabled = false, revisar = [], paises, idiomas, prefijoSlot, secciones = true, autoFocusNombre = false, avisarIdiomaNacionalidad = false, }) {
    const t = textosUI();
