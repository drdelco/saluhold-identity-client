...
exports.fichaEditableDesdeIdentity = exports.construirParchePaciente = exports.fechaISO = void 0;
 ...
 */
function construirParchePaciente(original, editado) {
    const parche = {};
    const borrar = [];
    const cambios = [];
...
exports.construirParchePaciente = construirParchePaciente;
/**
 ...
 */
function fichaEditableDesdeIdentity(raw) {
    const f = {};
    if (!raw)
        return f;
    for (const campo of CAMPOS_SIMPLES) {
...
exports.fichaEditableDesdeIdentity = fichaEditableDesdeIdentity;
