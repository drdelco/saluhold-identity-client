...
exports.interpolar = exports.textosUI = exports.configurarTextosUI = exports.TEXTOS_UI_ES = void 0;
exports.TEXTOS_UI_ES = {
...
let _textos = exports.TEXTOS_UI_ES;
/**
 ...
 */
function configurarTextosUI(parcial) {
    const dados = Object.entries(parcial).filter(([, v]) => typeof v === 'string');
    _textos = { ...exports.TEXTOS_UI_ES, ...Object.fromEntries(dados) };
}
exports.configurarTextosUI = configurarTextosUI;
/** Los textos vigentes. Se llama al pintar, no al importar. */
function textosUI() {
    return _textos;
}
exports.textosUI = textosUI;
/**
